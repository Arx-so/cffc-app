export default {
  ...
  moderation: {
    ...
    reasons: {
      spam: "Spam",
      nudity_or_violence: "Nudity or violence",
      harassment_or_bullying: "Harassment or bullying",
      fake_profile: "Fake profile",
      other: "Other",
    },
    reportSubmitted: "Report sent. Our team will review it within 24 hours.",
    reportError: "Couldn't send the report. Please try again.",
    blockConfirmTitle: "Block this user?",
    blockConfirmMessage: "You won't see their videos or profile anymore.",
  ...
  profile: {
    ...
    clubDetailsSubtitle: "Tap to see location and contact info.",
    detailsExpandA11yClub: "Expand club details",
    detailsCollapseA11yClub: "Collapse club details",
  },
  proProfile: {
    active: "Active",
  ...
  editProfile: {
    ...
    policyError: "Database permission error (profile policy).",
    toasts: {
  ...
  signup: {
    ...
    birthDatePlaceholder: "DD/MM/YYYY",
    foundingDateLabel: "FOUNDING DATE",
