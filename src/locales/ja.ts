export default {
  ...
  moderation: {
    ...
    reportReasonTitle: "報告する理由を選んでください",
    reasons: {
      spam: "スパム",
      nudity_or_violence: "ヌードまたは暴力的な内容",
      harassment_or_bullying: "嫌がらせ・いじめ",
      fake_profile: "偽のプロフィール",
      other: "その他",
    },
    reportSubmitted: "報告を送信しました。24時間以内に確認します。",
    reportError: "報告を送信できませんでした。もう一度お試しください。",
    blockConfirmTitle: "このユーザーをブロックしますか？",
    blockConfirmMessage: "このユーザーの動画やプロフィールは表示されなくなります。",
    blockConfirmButton: "ブロック",
    blockSuccess: "ユーザーをブロックしました。",
    blockError: "ユーザーをブロックできませんでした。もう一度お試しください。",
  },
  settings: {
    title: "設定",
    appearance: "外観",
  ...
  profile: {
    ...
    clubDetailsTitle: "クラブ詳細",
    clubDetailsSubtitle: "タップすると所在地・連絡先を表示します",
    detailsExpandA11yClub: "クラブ詳細を展開",
    detailsCollapseA11yClub: "クラブ詳細を閉じる",
  },
  proProfile: {
    active: "アクティブ",
    reputation: "評判",
  ...
  editProfile: {
    ...
    policyError: "データベースの権限エラー（profile ポリシー）。",
    toasts: {
